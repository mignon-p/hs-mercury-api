...
module System.Hardware.MercuryApi.Params
  ( -- * Type-safe getters and setters
    -- | These functions are automatically generated, so not
    -- all of them make sense.  For example,
    -- 'paramSetRadioTemperature' will always throw
    -- 'MercuryException' with status 'ERROR_READONLY'.
    paramGetBaudRate
  , paramSetBaudRate
  ...
  , paramSetAntennaConnectedPortList
  , paramGetAntennaPortList
  , paramSetAntennaPortList
  ...
  , paramSetRegionSupportedRegions
  ...
  , paramSetTagReadDataTagopFailures
  , paramGetTagReadDataTagopSuccesses
  , paramSetTagReadDataTagopSuccesses
