...
data Param =
  ...
  | PARAM_PROBEBAUDRATES -- ^ "/reader/probeBaudRates", (Not yet implemented)
  ...
  | PARAM_ANTENNA_CHECKPORT -- ^ "/reader/antenna/checkPort", (Not yet implemented)
  | PARAM_ANTENNA_PORTLIST -- ^ "/reader/antenna/portList", (Not yet implemented)
  | PARAM_ANTENNA_CONNECTEDPORTLIST -- ^ "/reader/antenna/connectedPortList", (Not yet implemented)
  | PARAM_ANTENNA_PORTSWITCHGPOS -- ^ "/reader/antenna/portSwitchGpos", (Not yet implemented)
  ...
  | PARAM_GPIO_INPUTLIST -- ^ "/reader/gpio/inputList", (Not yet implemented)
  | PARAM_GPIO_OUTPUTLIST -- ^ "/reader/gpio/outputList", (Not yet implemented)
  ...
  | PARAM_TAGREADDATA_RECORDHIGHESTRSSI -- ^ "/reader/tagReadData/recordHighestRssi", (Not yet implemented)
  | PARAM_TAGREADDATA_REPORTRSSIINDBM -- ^ "/reader/tagReadData/reportRssiInDbm", (Not yet implemented)
  | PARAM_TAGREADDATA_UNIQUEBYANTENNA -- ^ "/reader/tagReadData/uniqueByAntenna", (Not yet implemented)
  | PARAM_TAGREADDATA_UNIQUEBYDATA -- ^ "/reader/tagReadData/uniqueByData", (Not yet implemented)
  ...
  | PARAM_REGION_ID -- ^ "/reader/region/id", (Not yet implemented)
  | PARAM_REGION_SUPPORTEDREGIONS -- ^ "/reader/region/supportedRegions", (Not yet implemented)
  | PARAM_REGION_LBT_ENABLE -- ^ "/reader/region/lbt/enable", (Not yet implemented)
  | PARAM_LICENSE_KEY -- ^ "/reader/licenseKey", (Not yet implemented)
  | PARAM_USER_CONFIG -- ^ "/reader/userConfig", (Not yet implemented)
  | PARAM_RADIO_ENABLESJC -- ^ "/reader/radio/enableSJC", (Not yet implemented)
  | PARAM_EXTENDEDEPC -- ^ "/reader/extendedEpc", (Not yet implemented)
  ...
  | PARAM_STATUS_ENABLE_ANTENNAREPORT -- ^ "/reader/status/antennaEnable", (Not yet implemented)
  | PARAM_STATUS_ENABLE_FREQUENCYREPORT -- ^ "/reader/status/frequencyEnable", (Not yet implemented)
  | PARAM_STATUS_ENABLE_TEMPERATUREREPORT -- ^ "/reader/status/temperatureEnable", (Not yet implemented)
  | PARAM_TAGREADDATA_ENABLEREADFILTER -- ^ "/reader/tagReadData/enableReadFilter", (Not yet implemented)
  | PARAM_TAGREADDATA_READFILTERTIMEOUT -- ^ "/reader/tagReadData/readFilterTimeout", Int32
  | PARAM_TAGREADDATA_UNIQUEBYPROTOCOL -- ^ "/reader/tagReadData/uniqueByProtocol", (Not yet implemented)
  ...
  | PARAM_READER_WRITE_EARLY_EXIT -- ^ "/reader/gen2/writeEarlyExit", (Not yet implemented)
  | PARAM_READER_STATS_ENABLE -- ^ "reader/stats/enable", (Not yet implemented)
  | PARAM_TRIGGER_READ_GPI -- ^ "/reader/trigger/read/Gpi", (Not yet implemented)
